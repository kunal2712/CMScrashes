Climate model simulation crash prediction is a machine learning task that aims to predict whether a climate model simulation will crash or not. This can be useful for a number of reasons, such as:
